...
exports.run = (bot, message, args) => {
  ...
  var embed = new Discord.RichEmbed()
    ...
    .setTimestamp()
    .addField(
      "Dia em que entrou no servidor",
      moment(message.guild.member(message.author).joinedAt).format("LL"),
      true
    )
    .addField(
      "Quando você criou a sua conta:",
      moment(message.author.createdAt).format("LL"),
      true
    )
    .addField(
      "Seus Cargos:",
  ...
  if (message.mentions.users.size < 1)
    return xd.send({ embed }).then(message => {
      var embed = new Discord.RichEmbed()
        .setAuthor(
          "Rin-Bot",
          "https://cdn.discordapp.com/avatars/366922505480568852/8bc60c31c633300d19976f5a353784a6.png?size=2048"
        )
        .setDescription(
          "Mandei suas informações no canal <#366978821402001409>"
        )
        .setTimestamp()
        .setColor("#91489a");
  ...
  var embed = new Discord.RichEmbed()
    ...
    .setDescription(
      "Mandei as informações do usuário no canal <#366978821402001409>"
    )
  ...
  var embed = new Discord.RichEmbed()
    ...
    .addField(
      "Apelido do Membro:",
      message.guild.members.get(user.id).displayName,
      true
    )
    ...
    .addField(
      "Dia em que entrou no servidor",
      moment(message.guild.member(user).joinedAt).format("LL"),
      true
    )
